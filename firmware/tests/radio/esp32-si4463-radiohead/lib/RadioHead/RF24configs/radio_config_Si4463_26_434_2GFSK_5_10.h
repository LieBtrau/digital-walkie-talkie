...
// MOD_type: 3    Rsymb(sps): 5000    Fdev(Hz): 10000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 434    API_TC: 29    fhst: 250000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -406250 Hz
// # WB filter 2 (BW =  59.55 kHz);  NB-filter 2 (BW = 59.55 kHz)
// 
// Modulation index: 4
*/
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x03, 0x0D, 0x40, 0x05, 0x8C, 0xBA, 0x80, 0x00, 0x03
...
*/
#define RF_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x01, 0xB1, 0x01, 0x2E, 0x79, 0x00, 0x97, 0x02, 0xC2
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x11, 0x16, 0xCB, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x5F, 0x5F, 0x00, 0x1A, 0xFF, 0xFF, 0x00, 0x2A
...
*/
#define RF_MODEM_OOK_CNT1_8 0x11, 0x20, 0x08, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0x96, 0x01, 0x80
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x41, 0x0E, 0x27, 0x62, 0x4E, 0xC5, 0x20, 0xFE
