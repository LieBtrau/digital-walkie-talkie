...
// MOD_type: 5    Rsymb(sps): 2400    Fdev(Hz): 350    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
...
*/
#define RF_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x3A, 0x01, 0x00, 0x30, 0x30, 0x00, 0x02, 0x16, 0xAA, 0x00, 0x3E, 0x12
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x05, 0x00, 0x07, 0x01, 0x77, 0x00, 0x05, 0x8C, 0xBA, 0x80, 0x00, 0x00
...
//   MODEM_FREQ_DEV_0 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_FREQ_DEV_0_1_1 0x11, 0x20, 0x01, 0x0C, 0x55
...
//   MODEM_DECIMATION_CFG0 - Specifies miscellaneous parameters and decimator ratios for the Cascaded Integrator Comb (CIC) filter.
*/
#define RF_MODEM_TX_RAMP_DELAY_8_1 0x11, 0x20, 0x08, 0x18, 0x05, 0x00, 0x08, 0x03, 0x80, 0x00, 0x30, 0x20
...
//   MODEM_BCR_MISC1 - Miscellaneous control bits for the RX BCR loop.
*/
#define RF_MODEM_BCR_OSR_1_9_1 0x11, 0x20, 0x09, 0x22, 0x02, 0xA5, 0x00, 0xC1, 0x95, 0x00, 0xA6, 0x02, 0x02
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_AFC_GEAR_7_1 0x11, 0x20, 0x07, 0x2C, 0x00, 0x12, 0x80, 0x18, 0x0E, 0xC5, 0xA0
...
//   MODEM_OOK_PDTC - Configures the attack and decay times of the OOK Peak Detector.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9_1 0x11, 0x20, 0x09, 0x38, 0x11, 0x94, 0x94, 0x00, 0x1A, 0x12, 0xAB, 0x00, 0x2B
...
*/
#define RF_MODEM_OOK_CNT1_9 0x11, 0x20, 0x09, 0x42, 0xA4, 0x03, 0xD6, 0x03, 0x00, 0x19, 0x01, 0xF0, 0x80
